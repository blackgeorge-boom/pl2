...
amp [a,b] m curr_max =
                            if a == b then amp [b] m (max a curr_max)
                                ...
                                if a < b then 
                                        ...
                                        if (div (a - b) m == 0)
                                              then  let y = amp [b] m curr_max
                                                    in if (mod (a - b) m) == 0 then y else y + 1   
                                              else  let y = amp [b] m (max a curr_max)
                                                    in if (mod (a - b) m) == 0 then y else y + 1   
                                ...
                                if (a == c && a > b) then amp (b : c : xs) m (max a curr_max)
                                  ...
                                  if a == b then amp (b : c : xs) m (max a curr_max)
                                      ...
                                      if a < b then 
                                              ...
                                              if (div (a - b) m == 0)
                                                    then  let y = amp (b : c : xs) m curr_max
                                                          in if (mod (a - b) m) == 0 then y else y + 1     
                                                    else  let y = amp (b : c : xs) m (max a curr_max)
                                                          in if (mod (a - b) m) == 0 then y else y + 1     
